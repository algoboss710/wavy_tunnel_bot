...
#     check_entry_conditions, generate_trade_signal, run_strategy, execute_trade, manage_position, adjust_deviation_factor
# )
...
#         # This last call might be incorrectly expected, verify with debug prints
#         # mock_close_position.assert_any_call(3)  # Verify if multiple close calls expected
